...
<div class="row-fluid">
  ...
  <img src="https://ucsd-progsys.github.io/liquidhaskell-blog/static/img/why_types_1_1.png"
       height="200">
  <br> A list data type in Dafny (L) and LiquidHaskell (R) <br> 
  </div>
</div>
...
<div class="row-fluid">
  ...
  <img src="https://ucsd-progsys.github.io/liquidhaskell-blog/static/img/why_types_1_2.png"
       height="200">
  <br>Accessing the i-th element of a list in Dafny(L) and LiquidHaskell(R)<br>
  </div>
</div>
...
<div class="row-fluid">
  ...
  <img src="https://ucsd-progsys.github.io/liquidhaskell-blog/static/img/why_types_1_3.png"
       height="200">
  <br>Building and accessing a list in Dafny (L) and LiquidHaskell(R)<br>
  </div>
</div>
...
<div class="row-fluid">
  ...
  <img src="https://ucsd-progsys.github.io/liquidhaskell-blog/static/img/why_types_2_1.png"
       height="200">
  <br>A function defining the size of a list in Dafny (L) and LiquidHaskell (R)<br>
  </div>
</div>
...
<div class="row-fluid">
  ...
  <img src="https://ucsd-progsys.github.io/liquidhaskell-blog/static/img/why_types_2_2.png"
       height="200">
  <br>Verifying the size of a list in Dafny (L) and LiquidHaskell (R)<br>
  </div>
</div>
