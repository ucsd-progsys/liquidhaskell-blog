...
*type* positions. This generalization lets us exploit

* types as program logic, and
...
are even more pronounced when working with higher-order 
functions, e.g. `map`-ing or `fold`-ing over containers...
